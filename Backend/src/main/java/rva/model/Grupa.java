...
public class Grupa implements Serializable {
	...
	@Id
	@SequenceGenerator(name="GRUPA_ID_GENERATOR", sequenceName="GRUPA_ID_SEQ", allocationSize=1)
	...
	@ManyToOne
	@JoinColumn(name="smer")//kako se zove kolona iz koje dolazi strani kljuc
	private Smer smer;
